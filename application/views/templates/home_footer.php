...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> |<a href="https://colorlib.com" target="_blank">KangKaos</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></div>
                <nav class="footer_nav ml-md-auto order-md-2 order-1">
                  <ul class="d-flex flex-row align-items-center justify-content-start">
                    <li><a href="ocol.html">Women</a></li>
...
<script src="<?= base_url('assets/'); ?>styles/bootstrap-4.1.2/bootstrap.min.js"></script>
...
<script src="<?= base_url('assets/'); ?>plugins/progressbar/progressbar.min.js"></script>
