        ...
        <div id="carouselExampleIndicators" class="carousel slide " data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
              <img class="d-block img-fluid" src="<?= base_url('assets/') ?>images/product_1.jpg" alt="First slide" width= 100%>
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="<?= base_url('assets/') ?>images/product_1.jpg" alt="Second slide" width= 100%>
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="<?= base_url('assets/') ?>images/product_1.jpg"  alt="Third slide" width= 100%>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="row products_row">
          ...
          <div class="col-xl-4 col-md-6">
            <div class="product">
              <div class="product_image"><img src="<?= base_url('assets/'); ?>images/product_1.jpg" alt="" alt="" ></div>
          ...
          <div class="col-xl-4 col-md-6">
            <div class="product">
              <div class="product_image"><img src="<?= base_url('assets/'); ?>images/product_3.jpg" alt=""alt=""></div>
              <div class="product_content">
                <div class="product_info d-flex flex-row align-items-start justify-content-start">
                  <div>
                    <div>
