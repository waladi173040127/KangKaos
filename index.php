             ...
             <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $p['detail']; ?></td>
                        <td class="">
                            <a href="<?= base_url(); ?>Produk/edit/<?= $p['id']; ?>" class="badge badge-success">edit</a>
...
<!-- Modal edit -->
    ...
    <div class="modal fade" id="editProduk" tabindex="-1" role="dialog" aria-labelledby="editProduk" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="newSubMenuModalLabel">Add New Produk</h5>
